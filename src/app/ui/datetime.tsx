...
import { isDefined, isString, isObject, htmlBoolean, identity } from '../util/util'
...
const DateTimeFormat = areIntlLocalesSupported(['fi']) ? global.Intl.DateTimeFormat : getDateTimePolyfill()
...
export default class DateTime extends React.Component<DateTimeProps, DateTimeState> {
    ...
    public componentDidMount() {
        ...
        incoming.value = Bacon.combineTemplate({
            ...
            day: v.date.day, month: v.date.month, year: v.date.year,
    ...
    private renderType(type: any) {
        ...
        return <TextField type="text" value={this.state[type]} style={info.style}
            ...
            onChange={this.inputChanged} onFocus={this.focusChanged} read-only={htmlBoolean(info.readOnly || false, 'read-only')} />
    }
