...
nameDays[6][24]='Johannes, Juhani, Juha, Jukka, Janne, Juho, Jani, Jussi, Juhana';
nameDays[6][25]='Uuno';
...
nameDays[7][2]='Maria, Maija, Mari, Meeri, Marika, Maiju, Maaria, Maikki, Kukka-Maaria';
nameDays[7][3]='Arvo';
...
nameDays[8][15]='Marjatta, Marja, Jaana, Marjo, Marita, Marjut, Marianne, Maritta, Marjaana, Marjukka, Marianna';
nameDays[8][16]='Aulis';
...
nameDays[11][25]='Katri, Kaija, Katja, Kaisa, Kati, Kaarina, Kaisu, Riina, Katariina, Katriina';
...
export function getNameDay(month, day) {
    return isNumber(month) && isNumber(day) && month >= 1 && month <= 12 && day >= 1 && day <= 31
        && nameDays[month][day] ? nameDays[month][day] : undefined
}
