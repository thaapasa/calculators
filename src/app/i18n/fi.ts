export const fi = {
  ...
  'page.worktime.title': 'Työaika',
  'page.worktime.subtitle': 'Päivän työajan laskuri',
  'page.worktime.start': 'Alku',
  'page.worktime.entries': 'Kirjaukset',
  'page.worktime.end': 'Loppu',
  'page.worktime.now': 'Nyt',
  'page.worktime.setNow': 'Aseta nykyinen kellonaika',
  'page.worktime.clockIn': 'Aloita',
  'page.worktime.pause': 'Tauko',
  'page.worktime.resume': 'Jatka',
  'page.worktime.addRow': 'Lisää rivi',
  ...
  'page.worktime.worked': 'Työaika',
  'page.worktime.away': 'Poissa',
  'page.worktime.remaining': 'Jäljellä',
  'page.worktime.leaveAt': 'Lähtöaika',
  'page.worktime.noRows': 'Ei kirjauksia. Paina Aloita, kun aloitat työt.',
  ...
  'pipeline.input.mode.text': 'Teksti / tiedosto',
  'pipeline.input.mode.randomString': 'Satunnainen merkkijono',
  'pipeline.input.mode.randomBytes': 'Satunnaiset tavut',
  'pipeline.input.length': 'Pituus',
  'pipeline.input.regenerate': 'Luo uusi',
  'pipeline.input.randomBytesInfo': 'Satunnaista dataa',
  ...
  'pipeline.addPipeline': 'Lisää dataputki',
  'pipeline.removePipeline': 'Poista dataputki',
  'pipeline.defaultTitle': 'Dataputki',
  'pipeline.renameTitle': 'Nimeä dataputki',
  'pipeline.reset': 'Nollaa',
  'pipeline.saveSetup': 'Tallenna putkisto',
  'pipeline.saveSetupPrompt': 'Anna asetelmalle nimi',
  'pipeline.loadSetup': 'Lataa asetelma',
